...
int main()
{
	...
	cout << "Введите номер 1 сотрудника, пособие, дату в формате (xx/xx/xxxx), первую букву должности" << endl;
	...
	cout << "Введите номер 2 сотрудника, пособие, дату в формате (xx/xx/xxxx), первую букву должности" << endl;
	...
	cout << "Введите номер 3 сотрудника, пособие, дату в формате (xx/xx/xxxx), первую букву должности" << endl;
